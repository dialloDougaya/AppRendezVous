  ...
  <tbody>
    ...
    <?php
         ...
         $statut='';
             ...
             $bd=$con->prepare('SELECT Id_user,id_rend , type,contenu ,etat,ID_N from rendezvous,notification WHERE ID_R=id_rend AND ID_user=:id');
              $bd->bindvalue(':id',$val);
             $bd->execute();
          ...
          <td><?=$key['Id_user'];?></td>
           <td><?=$key['id_rend'];?></td>
            <td><?=$key['type'];?></td>
             ...
             <td><a href="traitementNotif.php?id=<?=$key['ID_N'];?>" class="btn btn-primary">Edite</a></td>
