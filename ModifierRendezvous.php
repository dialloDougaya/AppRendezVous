    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="listeRendezvousUser.php" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Rendez-Vous</span></a></li>
   ...
   $note=$_POST['note'];
    ...
    $verifi=false;
     ...
     $con=new PDO('mysql:localhost=host;dbname=apprendezvous','root','');
       ...
       $req=$con->prepare('UPDATE rendezvous SET DT_H_D=:dt1,DT_H_F=:dt2,statut=:statut,notes=:note WHERE ID_R=:id_r');
        ...
        <div class="row">
          ...
          <div class="col-lg-12 pt-6 pt-lg-0 content" data-aos="fade-left">
             ...
             <div class="row">
               ...
               <div class="text-center"><button type="submit" class="btn btn-primary" name="btn_envoyer">Modifie</button></div>

               <a href="listeRendezvousUser.php" style="text-align:right;">Retour</a>
